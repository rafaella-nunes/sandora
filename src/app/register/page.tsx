			...
			<Form {...form}>
				<form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
								...
								<FormItem>
									...
									<FormControl>
										<Input
											...
											aria-required="true"
											aria-invalid={
												form.formState.errors.whatsapp ? "true" : "false"
											}
											aria-describedby={
					...
					<p className="text-xs font-normal text-avisos">
						...
						<Popover>
							<PopoverTrigger asChild>
								<Link
									href="#"
									className="text-roxo-sandora underline"
									aria-label="Termos de Uso do Sandora"
								>
									Termos de Uso
								</Link>
							</PopoverTrigger>
							<PopoverContent className="w-80 max-h-60 overflow-y-auto text-xs">
								<div className="space-y-2">
									...
									<p className="text-sm text-muted-foreground">
										Este termo de consentimento foi elaborado em conformidade
										com a Lei Geral de Proteção de Dados (LGPD). Consoante ao
										artigo 5º inciso XII da Lei 13.709/2018, ao cadastrar-se, o
										titular/ responsável viabiliza a manifestação livre,
										informada e inequívoca do tratamento de seus dados pessoais.
										Ao se cadastrar em nossa plataforma, informações específicas
										sobre os usuários, como endereços de protocolo de Internet
										(IP), navegação no site, software do usuário, juntamente com
										outras informações semelhantes, serão armazenadas nos
										servidores de ML Plataformas Digitais e Marketing LTDA.
										Essas informações serão estritamente usadas apenas para fins
										estatísticos e não serão publicadas para acesso geral. Os
										dados da empresa e das pessoas denunciantes (quando se
										identificarem) estão protegidos e são tratados com total
										confidencialidade.
									</p>
								</div>
							</PopoverContent>
						...
						<Link
							href="#"
							className="text-roxo-sandora underline"
							aria-label="Política de Privacidade do Sandora"
						>
					...
					<Button
						...
						aria-label={
							isLoading ? "Processando cadastro" : "Criar conta no Sandora"
						}
					>
					...
					<div className="text-center font-normal text-sm text-avisos underline">
						<a
							href="/login"
							onClick={handleClick}
							aria-label="Já tem uma conta? Clique para entrar"
						>
